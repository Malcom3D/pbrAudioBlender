...
from . import worldND, baseND, materialND, inputND, outputND, freqpointND

for mod in (worldND, baseND, materialND, inputND, outputND, freqpointND):
    classes += mod.classes
...
input_node_categories = [
    MaterialNodeCategory("INPUT_NODES", "Input", items=[
        ...
        NodeItem("AcousticMaterialFrequencyCurve"),
    ]),
]
