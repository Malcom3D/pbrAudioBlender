...
class AudioResponseGraph(AcousticMaterialNode):
    """Audio Response Graph node"""
    bl_idname = 'AudioResponseGraph'
    bl_label = "Audio Response Graph"

    def init(self, context):
        pass

classes.append(AudioResponseGraph)
